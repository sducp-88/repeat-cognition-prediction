...
def build_supplement(output_dir: Path) -> str:
    ...
    sections = [
        "# Supplement",
        "",
        "**Article title:** Repeat Cognitive Assessment and Subsequent Memory Decline Across 3 National Aging Cohorts",
        "",
        "**Status:** Working supplement draft; licensing, citations, page numbers, and final eFigure numbering remain to be completed. Parent-cohort ethics and the local institutional-policy statement are complete.",
        "",
        "## Supplement Contents",
        "",
        ...
        "- eFigure 1. Calibration and Decision Curves in External Cohorts",
        "",
        "# eMethods",
        "",
        "## eMethods 1. Data Sources, Study Design, and Governance",
        "",
        "This prediction model study used the China Health and Retirement Longitudinal Study (CHARLS), the US Health and Retirement Study (HRS), and the English Longitudinal Study of Ageing (ELSA). CHARLS 2011, 2013, and 2015 formed the development sequence. HRS 2012, 2014, and 2016 formed the first cross-national external evaluation sequence. ELSA waves 6, 7, and 8 formed a locked confirmation sequence after the CHARLS models, preprocessing, primary outcome rule, and reporting code had been frozen and hashed. HRS had contributed to earlier exploratory work and was therefore not described as untouched confirmation. ELSA was not used to choose predictors, tune hyperparameters, revise score definitions, or refit model coefficients.",
        "",
        "All analyses were conducted within the local data environment under the applicable cohort data-use agreements. Person identifiers were used only for local linkage. No person-level cohort records or individual predictions were written to the project output directory. Saved outputs comprised aggregate tables, figures, code, fitted model objects without source records, software metadata, and cryptographic hashes. CHARLS, HRS, and ELSA received ethics approval from their responsible review committees and obtained participant informed consent. Under the institutional policy of the Second Qilu Hospital of Shandong University, this secondary analysis did not require additional ethics committee review or approval; accordingly, no separate written exemption determination was issued.",
        "",
        "## eMethods 2. Participants and Cognitive Measures",
        "",
        ...
        "## eFigure 1. Calibration and Decision Curves in External Cohorts",
        "",
        "Use `outputs/figure3_external_validation_calibration_decision_curve.png` if the calibration and decision-curve display is moved from the main manuscript to the Supplement during journal revision.",
        "",
        "# Supplement References",
        "",
        "[TO COMPLETE AFTER MAIN-MANUSCRIPT CITATION INTEGRATION]",
    ]
    return "\n".join(sections) + "\n"
